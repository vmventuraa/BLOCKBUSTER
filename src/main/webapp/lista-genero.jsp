		...
		<table class="table table-striped">
			...
			<c:forEach items="${generos }" var="g">
				<tr>
					...
					<td style="color:#fff;">${g.nome}</td>
					<td style="color:#fff;"><c:url value="genero" var="link">
							<c:param name="acao" value="abrir-form-edicao" />
							<c:param name="codigo" value="${g.id }" />
						...
						<button type="button" class="btn btn-warning btn-xs"
							...
							onclick="codigoExcluir.value = ${g.id}" style="color:#fff; background-color:red; border-color:red;">Excluir</button></td>
				</tr>
			</c:forEach>
		</table>
	</div>
	...
	<div class="modal fade" id="excluirModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">Deseja realmente excluir o gênero?</div>
